...
class ApiService {
  ...
  static const String _baseURL = "http://10.109.197.14:3009";
  ...
  static Future<List<dynamic>> getList(String path) async {
    ...
    if (res.statusCode == 200)
      return json.decode(res.body); //se deu certo interrompe o código aqui
    // se não deu certo a coneção -> gerar um erro
